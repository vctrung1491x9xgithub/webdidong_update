...
//     $result = mysqli_query($con, "Select id, tkadmin ,`email`, hotenadmin from admin WHERE `email` ='" . $socialUser['email'] . "'");
//     if ($result->num_rows == 0) {
//         $result = mysqli_query($conn, "INSERT INTO admin (hotenadmin,`email`, trangthai, ngaytao, ngaycapnhat) VALUES ('" . $socialUser['name'] . "', '" . $socialUser['email'] . "', 1, " . time() . ", '" . time() . "');");
//         if (!$result) {
//             echo mysqli_error($conn);
//             exit;
//         }
//         $result = mysqli_query($conn, "Select id, taikhoanadmin,`email`, hotenadmin from admin WHERE `email` ='" . $socialUser['email'] . "'");
//     }
//     if ($result->num_rows > 0) {

...
?>
    <div class="framework ">
        <div class="breadcrumb bg-white p-2 m-0 mb-3 shadow-sm">
            <h1><i class="ti-home text-secondary"></i><span class="mx-2">&#10095;</span><a href=""> Quản lý sản phẩm</a><span class="mx-2">&#10095;</span><span class="font-weight-bold">Danh sách điện thoại</span></h1>
        </div>
        ...
        <div class="table-responsive-lg p-2 bg-white shadow-sm border border-success" id="tbl-phone-listing">
            ...
            $totalRecords = mysqli_query($conn, "SELECT * FROM san_pham WHERE id_mat_hang = 'PHONE'");
            $totalRecords = $totalRecords->num_rows;
            $totalPages = ceil($totalRecords / $item_per_page);
            $products = mysqli_query($conn, "   SELECT *
                                                 FROM san_pham as sp, danh_muc_thuong_hieu as dmth
                                                 WHERE sp.id_thuong_hieu = dmth.id_thuong_hieu and sp.id_mat_hang = 'PHONE'  
            ...
            if ($products->num_rows > 0) { ?>
                ...
                <?php
                include '../pagination/phone_pagination.php';
                ?>
            <?php  } else {

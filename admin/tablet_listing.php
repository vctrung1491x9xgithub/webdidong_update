...
?>
    <div class="framework ">
        <div class="breadcrumb bg-white p-2 m-0 mb-3 shadow-sm">
            <h1><i class="ti-home text-secondary"></i><span class="mx-2">&#10095;</span><a href=""> Quản lý sản phẩm</a><span class="mx-2">&#10095;</span><span class="font-weight-bold">Danh sách tablet</span></h1>
        </div>
        ...
        <div class="table-responsive-lg p-2 bg-white shadow-sm border border-success" id="tbl-phone-listing">
            ...
            if ($products->num_rows > 0) { ?>
                <table class="table table-hover"">
                    <caption class="pb-2 border-bottom mb-2 font-weight-bold">Danh sách <?= $IDMH; ?> </caption>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-danger" href="./tablet_listing.php?action=del&id=<?= $row['id_san_pham'] ?>" onclick="return confirm('Bạn muốn xoá sản phẩm này này?')">
        ...
        if ($error) {
            echo '<script>
                            ...
                            span.onclick = function() {
                                window.location.href="tablet_listing.php";
                            }

...
if (isset($_POST['sortType']) && isset($_POST['txtSearch'])) {
    ...
    $find_order = mysqli_query($conn, $select_order);
    $find_order =  $find_order->num_rows;
    $totalPages = ceil($find_order / $item_per_page);
    $find_order = mysqli_query($conn, $page_order);
